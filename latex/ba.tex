...
\newcommand{\bearbeiter}{Ilias Ihadian}

% Geben Sie hier den Titel Ihrer Arbeit an:
\newcommand{\titel}{Enhanced Image Matting Algorithm using Local and Non-local Neighbors: A K-NN-based Color Modeling Approach}

% Geben Sie das Datum des Beginns und Ende der Bachelorarbeit ein:
\newcommand{\beginndatum}{03.05.2024}
\newcommand{\abgabedatum}{05.08.2024}

% Geben Sie die Namen des Erst- und Zweitgutachters an:
\newcommand{\erstgutachter}{Prof. Dr.~Stefan Conrad}
\newcommand{\zweitgutachter}{Prof. Dr. T. Dickscheid}
